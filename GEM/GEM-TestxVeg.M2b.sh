...
#SBATCH --job-name=GEM-TestxVeg-M2b
#SBATCH --nodes=1
...
--pheno-file $phenodir/TestxVeg_pheno.M2.csv \
--sampleid-name IID \
--pheno-name $j \
...
Fasting_time Mean_corpuscular_haemoglobin \
zblood BMI \
--robust 0 \
--exposure-names "$e" \
--threads 8 \
--out $outdir/$j/$e/M2b/chr"$i"
